...
<?php foreach($attributes->onlyProps(['id', 'maxWidth', 'modal' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div x-data="{
    ...
    }" wire:ignore.self class="modal fade" tabindex="-1" id="<?php echo e($id); ?>" aria-labelledby="<?php echo e($id); ?>"
  aria-hidden="true" x-ref="<?php echo e($id); ?>">
  <div class="modal-dialog<?php echo e($maxWidth); ?>">
    <?php echo e($slot); ?>

  </div>
</div>
<?php /**PATH C:\xampp\htdocs\AAPOS\resources\views/vendor/jetstream/components/modal.blade.php ENDPATH**/ ?>